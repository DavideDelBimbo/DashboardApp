...
export class SignupComponent {
	...
	/**
	 * Submits the form and attempts to sign up the user.
	...
	public onSubmit(form: NgForm): void {
		...
		const { firstName, lastName, email, password, rememberMe } = form.value;

		this._authService
			.signUp(firstName, lastName, email, password, rememberMe)
